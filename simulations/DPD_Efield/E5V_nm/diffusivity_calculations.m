...
collect_msd('with_efield_nafion.ion_diff','E5V_nm_nafion_ion_diff', 'seed_*', npoints);
collect_msd('with_efield_nafion.water_diff','E5V_nm_nafion_water_diff', 'seed_*', npoints);
