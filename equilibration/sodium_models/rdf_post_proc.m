...
plot_rdf_cn_error_area(bin_pos(1,:), all_rdf_oo, 'Oxegen in water - oxygen in water', 8, 4, [0.04,0.36,0.56], 'RDF')
...
plot_rdf_cn_error_area(bin_pos(1,:), all_cn_oo, 'Oxegen in water - oxygen in water', 80.0, 8, [0.72,0.24,0.04], 'CN')
